  ...
  return (
    <nav className="nav">
        ...
        <ul className="nav-link-container" ref={navRef}>
            ...
            <li className="nav-item"><a href="https://docs.google.com/document/d/1h216nrZcAgJZVN_qE_03IFTYkC0JWm9-6OrpQcKi3Fg/edit?usp=sharing" target="_blank" style={{color: props.navLinkColor}}>Documentation</a></li>
